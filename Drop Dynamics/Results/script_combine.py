...
# Droplet:
#dirName = '2D_AE/2d_ae_cropped_128_relu_reg_norm' #5 +
#dirName = '2D_AE/2d_ae_cropped_256_relu_reg_norm' +
#dirName = '2D_VAE/2d_beta_vae_cropped_128_relu_norm' # 4 +
#dirName = '2D_VAE/2d_vae_cropped_128_relu_norm' # 5 +
#dirName = '2D_VAE/2d_vae_cropped_256_relu_norm' # 2 +

# dirName = '3D_AE/3d_ae_cropped_256_relu_norm' +
# dirName = '3D_AE/3d_ae_cropped_256_relu_reg_norm' +
# dirName = '3D_AE/3d_ae_cropped_512_relu_reg_norm' +
# dirName = '3D_VAE/3d_beta2_vae_cropped_256_relu_norm' +
# dirName = '3D_VAE/3d_beta10_vae_cropped_256_relu_norm' +
# dirName = '3D_VAE/3d_beta100_vae_cropped_256_relu_norm' +
# dirName = '3D_VAE/3d_beta_vae_cropped_256_relu_norm' +
# dirName = '3D_VAE/3d_vae_cropped_256_relu_norm' +
# dirName = '3D_VAE/3d_vae_cropped_512_relu_norm' +
...
def load_images_from_folder(dirName):
    # dirName = '2D_VAE/2d_beta-vae_cropped_128_relu' # only 5 folders at a time!
    #dirName = '3D_AE/3d_ae_cropped_256_relu_norm'
...
dirNames = {'2D_AE/2d_ae_cropped_128_relu_reg_norm', \
'2D_AE/2d_ae_cropped_256_relu_reg_norm', \
'2D_VAE/2d_vae_cropped_128_relu_norm', \
'2D_VAE/2d_vae_cropped_256_relu_norm', \
'2D_VAE/2d_beta_vae_cropped_128_relu_norm', \
'3D_AE/3d_ae_cropped_256_relu_norm', \
'3D_AE/3d_ae_cropped_512_relu_norm', \
'3D_AE/3d_ae_cropped_256_relu_reg_norm', \
'3D_AE/3d_ae_cropped_512_relu_reg_norm', \
'3D_AE/3d_ae_cropped_128_relu_norm', \
'3D_AE/3d_ae_cropped_64_relu_norm', \
'3D_AE/3d_ae_cropped_32_relu_norm', \
'3D_VAE/3d_vae_cropped_256_relu_norm', \
'3D_VAE/3d_beta_vae_cropped_256_relu_norm', \
'3D_VAE/3d_beta2_vae_cropped_256_relu_norm', \
'3D_VAE/3d_beta10_vae_cropped_256_relu_norm', \
'3D_VAE/3d_beta100_vae_cropped_256_relu_norm', \
'3D_VAE/3d_vae_cropped_512_relu_norm', \
'3D_VAE/3d_beta0.5_vae_cropped_512_relu_norm', \
'Baseline/baseline_norm_crop'}
