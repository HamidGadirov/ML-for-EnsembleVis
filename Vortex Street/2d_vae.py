...
from keras.layers import Activation, Input, Dense, Conv2D, Conv2DTranspose, LeakyReLU
...
def main():
    ...
    model_names = {"2d_beta2_vae_cropped_128_relu_1.h5", "2d_beta2_vae_cropped_128_relu_2.h5", \
    "2d_beta2_vae_cropped_128_relu_3.h5", "2d_beta2_vae_cropped_128_relu_4.h5", "2d_beta2_vae_cropped_128_relu_5.h5", \
    "2d_beta0.5_vae_cropped_128_relu_1.h5", "2d_beta0.5_vae_cropped_128_relu_2.h5", \
    "2d_beta0.5_vae_cropped_128_relu_3.h5", "2d_beta0.5_vae_cropped_128_relu_4.h5", "2d_beta0.5_vae_cropped_128_relu_5.h5", \
    "2d_beta_vae_cropped_128_relu_1.h5", "2d_beta_vae_cropped_128_relu_2.h5", \
    "2d_beta_vae_cropped_128_relu_3.h5", "2d_beta_vae_cropped_128_relu_4.h5", "2d_beta_vae_cropped_128_relu_5.h5", \
    "2d_vae_cropped_128_relu_1.h5", "2d_vae_cropped_128_relu_2.h5", \
    "2d_vae_cropped_128_relu_3.h5", "2d_vae_cropped_128_relu_4.h5", "2d_vae_cropped_128_relu_5.h5", \
    "2d_vae_cropped_256_relu_1.h5", "2d_vae_cropped_256_relu_2.h5", \
    "2d_vae_cropped_256_relu_3.h5", "2d_vae_cropped_256_relu_4.h5", "2d_vae_cropped_256_relu_5.h5"}

    dataset = "flow"
    title = '2D VAE: ' # for subtitle

    #model_names = {"2d_beta2_vae_cropped_128_relu_1.h5"}
    ...
    for model_name in model_names:
        ...
        if not load_data:
            ...
            #for model_name in model_names: # diff parameters
                ...
                #     model = model_name[:-3]
                #     model += "_"+(str)experiment
                #     model += model_name[-3:]
                #     model_name = model

            # Grid search in: latent_dim, activation,
            ...
            if (latent_vector == True): # generate the latent vector
                ...
                decoded = generate_fully_conn(decoded_input, encoded_shape, activation='sigmoid', kernel_initializer='glorot_uniform')
            else:
            ...
            #visualize_keras(x_train[:,int(0.3*x_train.shape[1]):,:,:], encoder, decoder)
            ...
            # the range is no longer in [-1,1] after sampling (reparameterization)
            ...
            #print(encoded_vec[0]) # sampling, so it will vary -> fix the random seed +
