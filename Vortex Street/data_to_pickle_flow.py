...
def main():
    ...
    dirName = 'sampled-300' # sampled-300
    ...
    pkl_file = open("sampled-300_data.pkl", 'wb')
    pickle.dump(data, pkl_file)
    pkl_file.close

    pkl_file = open("sampled-300_names.pkl", 'wb')
    pickle.dump(cylinder_names, pkl_file)
    pkl_file.close


    pkl_file = open("sampled-300_data.pkl", 'rb')
    data = []
    data = pickle.load(pkl_file)

    pkl_file = open("sampled-300_names.pkl", 'rb')
    names = []
